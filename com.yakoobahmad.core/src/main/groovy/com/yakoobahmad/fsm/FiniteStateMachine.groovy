...
class FiniteStateMachine {
    ...
    private String getCallerClassName(){
        Thread.currentThread().getStackTrace().find { it.className.contains("com.yakoobahmad") && !it.className.contains("FSM") && !it.className.contains("com.yakoobahmad.fsm.FiniteStateMachine") }?.className
    }
